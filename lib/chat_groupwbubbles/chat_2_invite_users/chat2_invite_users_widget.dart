          ...
          title: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    'a2dy5wct' /* Select users from below to sta... */,
                  ),
                        ...
                        if (widget!.chatRef != null) {
                          ...
                          await chatsRecordReference.set({
                            ...createChatsRecordData(
                              ...
                              groupName: random_data.randomName(true, false),
                            ),
                            ...mapToFirestore(
                              {
                                'users': _model.friendsList,
