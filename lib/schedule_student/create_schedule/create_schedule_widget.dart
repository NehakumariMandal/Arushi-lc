...
import 'create_schedule_model.dart';
export 'create_schedule_model.dart';
              ...
              children: [
                      ...
                      onTap: () async {
                        await showModalBottomSheet(
                          ...
                          builder: (context) {
                            ...
                            safeSetState(() => _model.userRefSelected = value));
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                if (_model.userRefSelected?.reference != null)
                                  Expanded(
                                    child: wrapWithModel(
                                      model: _model.userListMemberModel,
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      await ScheduleStudentsRecord.collection.doc().set({
                        ...createScheduleStudentsRecordData(
                          ...
                          fridayEnd: dateTimeFormat(
                            'jm',
                            _model.datePicked5,
                            locale: FFLocalizations.of(context).languageCode,
                          ),
                          fridayClass: _model.textController5.text,
                          studentName: _model.userRefSelected?.displayName,
                          studentPhoto: _model.userRefSelected?.displayPhoto,
                        ),
                        ...mapToFirestore(
                          {
                            'notifyUsers': [_model.userRefSelected?.reference],
                          },
                        ),
                      });
