  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData) {
          return Scaffold(
            backgroundColor: Color(0xFF05C7F2),
            body: Center(
              child: SizedBox(
                width: 50.0,
                height: 50.0,
        ...
        List<UsersRecord> homeCopyUsersRecordList = snapshot.data!;

        final homeCopyUsersRecord = homeCopyUsersRecordList.isNotEmpty
            ? homeCopyUsersRecordList.first
            : null;
                      ...
                      children: [
                        Padding(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.asset(
                              'assets/images/75-750491_sndt-women-s-university-sndt-womens-university-logo.png',
                              width: 76.0,
                              height: 50.0,
                              fit: BoxFit.contain,
                            ),
                      ...
                      onTap: () async {
                        context.pushNamed(
                          ...
                          extra: <String, dynamic>{
                            'viewProfile': homeCopyUsersRecord,
                          },
                        );
                      },
                      child: Row(
