...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF03A9F4);
  late Color secondary = const Color(0xFFC2C5C5);
  late Color tertiary = const Color(0xFFFFA000);
  late Color alternate = const Color(0xFFFCFDFD);
  late Color primaryText = const Color(0xFF333333);
  late Color secondaryText = const Color(0xFF666666);
  late Color primaryBackground = const Color(0xFFE0DFDF);
  late Color secondaryBackground = const Color(0xFFF4F4F4);
  late Color accent1 = const Color(0xFFFF847C);
  late Color accent2 = const Color(0xFFFECEAB);
  late Color accent3 = const Color(0xFF99B898);
  late Color accent4 = const Color(0xFF2A363B);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFC2C5C5);
  late Color tertiary = const Color(0xFFFFA000);
  late Color alternate = const Color(0xFFF9FAFA);
  ...
  late Color accent1 = const Color(0xFFE6746B);
  late Color accent2 = const Color(0xFFE6B98F);
  late Color accent3 = const Color(0xFF6D8D77);
  late Color accent4 = const Color(0xFF19252A);
  ...
  late Color info = const Color(0xFF039BE5);
}
